...
My name is **Alfonso Antonio** — but you can call me **“AA”**.

I'm **25 years old** and currently based in **Manila, Philippines** :flag_ph:. 

I recently graduated last 2024 on **FEU Alabang** 🔰 with a degree of **Computer Engineering**.   
...
### ⚙️ **Home Lab (K8s + Docker)**
A sandbox environment for learning deployments, container orchestration, and monitoring using Kubernetes and Docker.

### 📊 **Monitoring Stack**
Built a Prometheus + Grafana setup to visualize CPU, RAM, and service uptime metrics, including custom dashboards.

### 🌐 **Portfolio Website**
A minimalist personal site showcasing my work.  
